<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TSRejected.aspx.cs" Inherits="TSRejected" %>
...
<head id="Head1" runat="server">
    <title>Rejected Timesheets</title>
...
<body>
    ...
    <form id="form1" runat="server" class="appform">
        ...
        Rejected Timesheets <asp:Label ID="LabelCountTS" runat="server" />
...
<AlternatingRowStyle BackColor="WhiteSmoke"></AlternatingRowStyle>
            ...
            <asp:SqlDataSource ID="SqlDataSourceTS" runat="server" 
                ...
                SelectCommand="SELECT [TimesheetNumber], Replace(Convert(varchar(9),TimesheetDate,6),' ','-') as TimesheetDate, 
                               ...
                               [RejectedBy], [RejectedDate], [SubmittedDate], [SubmittedBy], [RejectedReason] 
                               ...
                               AND [Rejected] = 1 AND PendingAdjustment = 0 ORDER BY [RejectedDate], [SubmittedDate]">
                <SelectParameters>
