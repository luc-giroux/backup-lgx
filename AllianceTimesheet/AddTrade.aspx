<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AddTrade.aspx.cs" Inherits="AddTrade" %>
    ...
    <form id="form1" runat="server" class="appform">
        ...
        <div class="appcontent">
            <fieldset>
                    ...
                    <ol>
                    <li>
                        <label for="WS">Trade<em>*</em></label>
                        <asp:TextBox ID="TextBoxTrade" runat="server" Width="300px"></asp:TextBox>
                    </li>
                    <li>
        ...
        <asp:TextBoxWatermarkExtender ID="TextBoxWatermarkExtender1" runat="server" TargetControlID="TextBoxTrade" 
