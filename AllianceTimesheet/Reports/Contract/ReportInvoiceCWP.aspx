<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ReportInvoiceCWP.aspx.cs" Inherits="Reports_Contract_ReportInvoiceCWP" %>
...
<head id="Head1" runat="server">
    <title>CWP Invoice Report</title>
        ...
        <div class="appcontent" align="center">
           ...
           <br />
            ...
            <rsweb:ReportViewer ID="ReportViewer1" runat="server" Font-Names="Verdana" 
                ...
                Height="600px">
                <LocalReport ReportPath="Reports/Contract/ReportCWP.rdlc">
                    <DataSources>
            ...
            <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" 
                ...
                TypeName="DataSetReportsTableAdapters.ReportInvoiceCWPTableAdapter" 
