...
public partial class ReportVariation : System.Web.UI.Page
{
    ...
    protected void ButtonViewReport_Click(object sender, EventArgs e)
    {
        if (InputFieldsAreOK())
        {
            ...
            try
            {
                ...
                ReportParameter rp1 = new ReportParameter("ReportTitle", "Extra Work report from " + TextBoxStartDate.Text + " to " + TextBoxEndDate.Text);
