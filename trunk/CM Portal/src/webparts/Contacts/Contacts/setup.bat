...
"C:\Program Files\Common Files\Microsoft Shared\web server extensions\12\BIN\stsadm.exe" -o retractsolution -name Contacts.wsp -url http://localhost -immediate
...
"C:\Program Files\Common Files\Microsoft Shared\web server extensions\12\BIN\stsadm.exe" -o deploysolution -name Contacts.wsp -url http://localhost -immediate -allowGacDeployment
