...
/// <summary>
/// LGX: class created to extend the ReportInvoiceCWPTableAdapter class to add a 
/// method to set the timeout of the query because by default for a tableadapter 
/// the timeout is set to 30 seconds. 
/// </summary>
public partial class ReportInvoiceCWPTableAdapterExtended : ReportInvoiceCWPTableAdapter
{
