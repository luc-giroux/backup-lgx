<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ReportContractProfileHistory.aspx.cs" Inherits="ReportContractProfileHistory" %>
...
<head id="Head1" runat="server">
    <title>Contract Profile History Report</title>
        ...
        <div class="appcontent" align="center">
           ...
           <br />
            <rsweb:ReportViewer ID="ReportViewer1" runat="server" Font-Names="Verdana" 
                ...
                Height="600px">
                <LocalReport ReportPath="Reports/Contract/ReportContractProfileHistory.rdlc">
                    <DataSources>
