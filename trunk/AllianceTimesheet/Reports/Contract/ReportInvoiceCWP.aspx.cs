...
public partial class Reports_Contract_ReportInvoiceCWP : System.Web.UI.Page
{
    ...
    protected void ButtonViewReport_Click(object sender, EventArgs e)
    {
        if (InputFieldsAreOK())
        {
            ...
            try
            {
                ...
                DataSetReports.ReportInvoiceCWPDataTable cwpdt = new DataSetReports.ReportInvoiceCWPDataTable();
                ReportInvoiceCWPTableAdapterExtended ta = new ReportInvoiceCWPTableAdapterExtended();
                ...
                ReportParameter rp1 = new ReportParameter("ReportTitle", "Contract base scope INVOICE report from " + TextBoxStartDate.Text + " to " + TextBoxEndDate.Text);
