...
public partial class Reports_ReportAgreedSuspensionInvoice : System.Web.UI.Page
{
    ...
    protected void ButtonViewReport_Click(object sender, EventArgs e)
    {
        if (InputFieldsAreOK())
        {
            ...
            try
            {
                ...
                DataSetReports.AgreedSuspensionInvoiceDataTable asdt = new DataSetReports.AgreedSuspensionInvoiceDataTable();
                DataSetReportsTableAdapters.AgreedSuspensionInvoiceTableAdapter ta = new DataSetReportsTableAdapters.AgreedSuspensionInvoiceTableAdapter();
                ta.Fill(asdt, (String)HttpContext.Current.Session["currentContract"], Convert.ToDateTime(TextBoxStartDate.Text), Convert.ToDateTime(TextBoxEndDate.Text));

                // We add several parameters in order to display them in the report
                System.Data.DataTable dt = asdt;
                ...
                ReportParameter rp1 = new ReportParameter("ReportTitle", "Agreed Suspension INVOICE report from " + TextBoxStartDate.Text + " to " + TextBoxEndDate.Text);
