<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ReportInvoiceVariation.aspx.cs" Inherits="Reports_Contract_ReportInvoiceVariation" %>
...
<head id="Head1" runat="server">
    <title>Invoice Variation Report</title>
        ...
        <div class="appcontent" align="center">
           ...
           <br />
            ...
            <rsweb:ReportViewer ID="ReportViewer1" runat="server" Font-Names="Verdana" 
                ...
                Height="600px">
                <LocalReport ReportPath="Reports/Contract/ReportVariation.rdlc">
                    <DataSources>
            ...
            <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" 
                ...
                TypeName="DataSetReportsTableAdapters.ReportInvoiceVariationTableAdapter" 
