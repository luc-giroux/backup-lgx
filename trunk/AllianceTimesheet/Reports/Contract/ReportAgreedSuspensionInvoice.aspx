<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ReportAgreedSuspensionInvoice.aspx.cs" Inherits="Reports_ReportAgreedSuspensionInvoice" %>
...
<head id="Head1" runat="server">
    <title>Agreed Suspension Invoice Report</title>
        ...
        <div class="appcontent" align="center">
           ...
           <br />
            ...
            <rsweb:ReportViewer ID="ReportViewer1" runat="server" Font-Names="Verdana" 
                ...
                Height="600px">
                <LocalReport ReportPath="Reports/Contract/ReportAgreedSuspension.rdlc">
                    <DataSources>
            ...
            <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" 
                ...
                TypeName="DataSetReportsTableAdapters.AgeredSuspensionInvoiceTableAdapter" 
