...
public partial class ReportAgreedSuspension : System.Web.UI.Page
{
    ...
    protected void ButtonViewReport_Click(object sender, EventArgs e)
    {
        if (InputFieldsAreOK())
        {
            ...
            try
            {
                ...
                DataSetReports.AgreedSuspensionDataTable asdt = new DataSetReports.AgreedSuspensionDataTable();
                DataSetReportsTableAdapters.AgreedSuspensionTableAdapter ta = new DataSetReportsTableAdapters.AgreedSuspensionTableAdapter();
                ...
                ReportParameter rp1 = new ReportParameter("ReportTitle", "Agreed Suspension report from " + TextBoxStartDate.Text + " to " + TextBoxEndDate.Text);
