<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ReportProgressVariation.aspx.cs" Inherits="ReportProgressVariation" %>
...
<head id="Head1" runat="server">
    <title>Variation Progress Report</title>
           ...
           <br />
            <asp:Panel ID="PanelReport" runat="server" Width="100%" Height="300px">
                <rsweb:ReportViewer ID="ReportViewer1" runat="server" Font-Names="Verdana" 
                    ...
                    Height="600px">
                    <LocalReport ReportPath="Reports/Progress/ReportProgressVariation.rdlc">
                        <DataSources>
