<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ReportManHourByTrade.aspx.cs" Inherits="ReportManHourByTrade" %>
...
<head id="Head1" runat="server">
    <title>Report Man Hour by Trade</title>
    ...
    <form id="form1" runat="server" class="appform">     
        ...
        <div class="appcontent" align="center">
            ...
            <fieldset>
                ...
                <label for="Scope">Scope<em>*</em> : </label>
                <asp:DropDownList ID="DropDownListScope" runat="server">
                    <asp:ListItem Text="Base Scope" Value="BASE_SCOPE" />
                    <asp:ListItem Text="Variations" Value="VARIATIONS" />
                </asp:DropDownList>
                ...
                <label for="EndDate">To Date<em>*</em> : </label>
                <asp:TextBox ID="TextBoxEndDate" runat="server"></asp:TextBox>
                <asp:CalendarExtender  ID="CalendarExtender2" runat="server" targetControlID="TextBoxEndDate" Format="dd-MMM-yy">
                </asp:CalendarExtender>
           ...
           <br />
            ...
            <rsweb:ReportViewer ID="ReportViewer1" runat="server" Font-Names="Verdana" 
                ...
                Height="600px">
                <LocalReport ReportPath="Reports/Progress/ReportHoursByTrade.rdlc">
                    <DataSources>
