...
public partial class ReportProgressVariation : System.Web.UI.Page
{
    ...
    protected void ButtonViewReport_Click(object sender, EventArgs e)
    {
        if (InputFieldsAreOK())
        {
            ...
            try
            {
                ...
                ReportParameter rp1 = new ReportParameter("ReportTitle", "Extra work weekly progess report from " + TextBoxStartDate.Text);
